...
//                 child: Row(
//                   children: [
//                     Image.asset("assets/images/ic_folder.png",width: 24,height: 24,),
...
//                       icon="assets/images/ic_excel.png";
...
//                       icon="assets/images/ic_power_point.png";
//                     }else if(root.files[index].name.contains(".xls")){
//                       icon="assets/images/ic_excel.png";
//                     }
//                   return Container(
...
//       icon="assets/images/ic_excel.png";
//     }else if(root.name.contains(".pptx")){
//       icon="assets/images/ic_power_point.png";
...
//       icon="assets/images/ic_power_point.png";
//     }else if(root.name.contains(".xls")){
//       icon="assets/images/ic_excel.png";
//     }
//     return Container(
//         margin: EdgeInsets.only(bottom: 18,top: 10),
...
//                   Row(
//                     children: [
//                       Image.asset('assets/images/ic_details.png',width: 20,height: 20,),
//                       const SizedBox(width: 10,),
//                       Container(
//                         margin: EdgeInsets.only(top: 6),
...
//                   Row(
//                     children: [
//                       Image.asset('assets/images/ic_history.png',width: 20,height: 20,),
//                       const SizedBox(width: 10,),
//                       Container(
//                         margin: EdgeInsets.only(top: 6),
